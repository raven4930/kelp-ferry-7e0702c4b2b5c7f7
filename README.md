...
Schedule preventative household care before repairs become emergencies.

This repository contains a complete, local-first TypeScript web application. It is generated as
an independent project, and its neutral repository name is **kelp-ferry-7e0702c4b2b5c7f7**.

## What it does

- Captures and validates maintenance job records.
